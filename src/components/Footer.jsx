  ...
  return (
    ...
    >
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-20 -right-20 w-40 h-40 bg-gradient-to-r from-[#2E3E88]/10 to-[#32B9CC]/10 rounded-full blur-3xl"></div>
        <div className="absolute -bottom-20 -left-20 w-40 h-40 bg-gradient-to-r from-[#32B9CC]/10 to-[#2E3E88]/10 rounded-full blur-3xl"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-60 h-60 bg-gradient-to-r from-[#2E3E88]/5 to-[#32B9CC]/5 rounded-full blur-3xl"></div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          >
            <Link to="/" className="inline-block mb-6">
              <div className="flex items-center gap-3">
                ...
                />
                <span className="text-2xl font-bold bg-gradient-to-r from-[#2E3E88] to-[#32B9CC] bg-clip-text text-transparent">
                  Triple S
                </span>
              </div>
            </Link>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-gray-300 hover:text-white transition-colors">
                <FaPhone className="text-[#32B9CC] text-sm" />
                <span className="text-sm">+20 115 942 4411</span>
              </div>
              <div className="flex items-center gap-3 text-gray-300 hover:text-white transition-colors">
                <FaEnvelope className="text-[#32B9CC] text-sm" />
                <span className="text-sm">info@Triple-S.com</span>
              </div>
              <div className="flex items-center gap-3 text-gray-300 hover:text-white transition-colors">
                <FaMapMarkerAlt className="text-[#32B9CC] text-sm" />
          ...
          >
            <h3 className="text-lg font-bold mb-6 relative inline-block">
              روابط سريعة
              <div className="absolute bottom-0 right-0 w-1/2 h-0.5 bg-gradient-to-r from-[#32B9CC] to-[#2E3E88]"></div>
            </h3>
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  ...
                  >
                    <FaArrowRight className="text-[#32B9CC] text-xs opacity-0 group-hover:opacity-100 transition-all duration-300 transform -translate-x-2 group-hover:translate-x-0 rotate-180" />
      ...
      <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-[#2E3E88] via-[#32B9CC] to-[#2E3E88]"></div>
    </footer>
  );
};
