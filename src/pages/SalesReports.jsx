  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-black/70 backdrop-blur-sm">
      <motion.div
        ...
        className="relative bg-white rounded-2xl sm:rounded-3xl w-full max-w-4xl max-h-[90vh] overflow-hidden shadow-2xl"
        dir="rtl"
      >
        {/* Header */}
        <div
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div>
                <h2 className="text-base sm:text-xl font-bold text-white whitespace-nowrap overflow-hidden text-ellipsis">
        ...
        {/* Content */}
        <div className="overflow-y-auto max-h-[calc(90vh-80px)] p-3 sm:p-6">
          ...
          <div className="mb-4 sm:mb-6">
            ...
            {order.items && order.items.length > 0 ? (
              <div className="space-y-3 sm:space-y-4">
                {order.items.map((item, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="bg-white border rounded-xl p-3 sm:p-4 hover:shadow-lg transition-shadow duration-200"
                      style={{
                        border: "1px solid #2E3E8820",
                        background: "linear-gradient(135deg, #f8f9ff, #ffffff)",
                      }}
                      ...
                      <div className="flex flex-col md:flex-row gap-3 sm:gap-4">
                        {(item.menuItem?.imageUrl ||
                          ...
                          <div className="md:w-1/4">
                            <div className="relative w-full h-32 sm:h-48 md:h-40 rounded-lg overflow-hidden">
                              <img
                                src={`${BASE_URL}/${
                                  item.menuItem?.imageUrl ||
                                  item.menuItemImageUrlSnapshotAtOrder
                            ...
                            >
                              ...
                              <div className="space-y-2">
                                {item.options.map((option, optionIndex) => (
                                  <div
                                    key={optionIndex}
                                    className="flex justify-between items-center bg-white px-2 sm:px-3 py-1 sm:py-2 rounded-md border"
                                    style={{
                                      border: "1px solid #2E3E8820",
                                    }}
                                  >
              ...
              <div
                className="text-center py-6 sm:py-8 rounded-xl"
                style={{
                  background: "linear-gradient(135deg, #f8f9ff, #ffffff)",
                  border: "1px solid #2E3E8820",
                }}
              >
                <FaBox
                  className="mx-auto text-2xl sm:text-3xl mb-3"
                  style={{ color: "#2E3E88" }}
                />
          ...
          <div
            className="rounded-xl p-3 sm:p-4 border mb-4 sm:mb-6"
            style={{
              background: "linear-gradient(135deg, #f8f9ff, #ffffff)",
              border: "1px solid #2E3E8820",
            }}
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              <div className="inline-flex items-center justify-center p-3 sm:p-4 rounded-xl sm:rounded-2xl bg-white/20 backdrop-blur-sm mb-4 sm:mb-6">
                <FaChartBar className="text-white text-2xl sm:text-4xl" />
              </div>
              <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4">
                تقارير المبيعات
              </h1>
              <p className="text-white/80 text-sm sm:text-lg md:text-xl max-w-2xl mx-auto px-2">
        ...
        <div className="w-full">
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-3 sm:gap-4">
              {/* من تاريخ - يأخذ 2 عمود على الشاشات الكبيرة */}
              <div className="lg:col-span-2">
                ...
                <div className="relative">
                  <FaCalendarAlt
                    className="absolute right-3 top-1/2 transform -translate-y-1/2 text-sm sm:text-base"
                    style={{ color: "#2E3E88" }}
                  />
                  <DatePicker
                    selected={startDate}
                    ...
                    className="w-full pr-10 pl-3 py-2 sm:py-2.5 border border-gray-200 rounded-xl outline-none focus:ring-2 focus:ring-[#2E3E88]/30 focus:border-[#2E3E88] transition-all duration-200 text-right text-sm sm:text-base"
                    style={{
                      background: "linear-gradient(135deg, #f8f9ff, #ffffff)",
                    }}
                    locale="ar"
              ...
              {/* إلى تاريخ - يأخذ 2 عمود على الشاشات الكبيرة */}
              <div className="lg:col-span-2">
                <label
                  className="block text-xs sm:text-sm font-semibold mb-2"
                  style={{ color: "#2E3E88" }}
              ...
              {/* الفرع - يأخذ 2 عمود على الشاشات الكبيرة */}
                ...
                <div className="relative">
                  <div className="relative">
                    <button
                      ...
                      className="w-full flex items-center justify-between border border-gray-200 rounded-xl px-3 sm:px-4 py-2 sm:py-2.5 transition-all hover:border-[#2E3E88] group text-right"
                      style={{
                        background: "linear-gradient(135deg, #f8f9ff, #ffffff)",
                      }}
                    >
                    ...
                    {isBranchDropdownOpen && (
                      ...
                      >
                        <li
                          ...
                          className="px-3 sm:px-4 py-2 sm:py-3 hover:bg-gradient-to-r hover:from-[#2E3E88]/5 hover:to-[#32B9CC]/5 cursor-pointer transition-all border-b last:border-b-0 text-right"
                        >
              ...
              {/* إجراءات التقرير - يأخذ 5 أعمدة على الشاشات الكبيرة */}
              <div className="lg:col-span-5">
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                  <motion.button
                    ...
                    className={`flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-xl font-semibold transition-all duration-300 flex items-center justify-center gap-2 text-xs sm:text-sm ${
                      startDate && endDate
                  ...
                  {reportData && reportData.length > 0 && (
                    <motion.button
                      ...
                      onClick={handlePrint}
                      disabled={isPrinting}
                      className={`flex-1 flex items-center justify-center gap-2 px-3 sm:px-4 py-2 sm:py-3 rounded-xl font-semibold transition-all duration-300 text-xs sm:text-sm ${
                        isPrinting
                          ? "opacity-50 cursor-not-allowed"
                          : "shadow-lg hover:shadow-xl cursor-pointer"
                      }`}
                    ...
                    >
                      {isPrinting ? (
                        <>
                          <div
                            className="animate-spin rounded-full h-4 w-4 sm:h-5 sm:w-5 border-b-2 mr-1 sm:mr-2"
          ...
          {summary && (
            ...
            >
              {/* Total Sales Card */}
              <div className="bg-white rounded-xl sm:rounded-2xl p-3 sm:p-5 shadow-xl text-right">
                <div className="flex items-center justify-between">
                  <div>
                    <p
          ...
          {summary?.topProducts && summary.topProducts.length > 0 && (
            <motion.div
              ...
              className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 mb-4 sm:mb-6 shadow-xl text-right"
            >
              ...
              <div className="space-y-2 sm:space-y-3">
                {summary.topProducts.map((product, index) => (
                  <div
                    key={index}
                    className="flex items-center justify-between p-2 sm:p-3 rounded-lg hover:shadow-md transition-all duration-200 text-right"
                    style={{
                      background: "linear-gradient(135deg, #f8f9ff, #ffffff)",
                      border: "1px solid #2E3E8820",
                    }}
                  >
                    <div className="flex items-center gap-2 sm:gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs" style={{ color: "#32B9CC" }}>
          ...
          {reportData && reportData.length > 0 && (
            <>
              ...
              >
                <div className="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-100 text-right">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-right min-w-[800px]">
                    ...
                    >
                      <tr>
                        <th
                          className="px-3 sm:px-4 py-2 sm:py-3 text-right font-semibold text-xs sm:text-sm"
                          style={{ color: "#2E3E88" }}
                        >
                          رقم الطلب
                        </th>
                    ...
                    <tbody className="divide-y divide-gray-100">
                      {reportData.map((order) => (
                        ...
                        >
                          <td
                            className="px-3 sm:px-4 py-2 sm:py-3 text-right font-mono text-xs sm:text-sm font-bold"
                            style={{ color: "#2E3E88" }}
                          >
                            {order.orderNumber}
                          </td>
                          <td
                            className="px-3 sm:px-4 py-2 sm:py-3 text-right text-xs sm:text-sm"
                            style={{ color: "#2E3E88" }}
                          >
                          ...
                          <td className="px-3 sm:px-4 py-2 sm:py-3 text-right">
                            <span
                              className={`inline-flex items-center gap-1 px-2 sm:px-3 py-1 rounded-full text-xs font-medium ${getStatusClass(
                                order.status,
                              )}`}
                            >
                              {getStatusIcon(order.status)}
                          ...
                          <td
                            className="px-3 sm:px-4 py-2 sm:py-3 text-right font-bold text-xs sm:text-sm"
                            style={{
                              background:
                                "linear-gradient(135deg, #2E3E88, #32B9CC)",
                              WebkitBackgroundClip: "text",
                          ...
                          <td className="px-3 sm:px-4 py-2 sm:py-3 text-right">
                            <motion.button
                              ...
                              className="flex items-center justify-center gap-1 sm:gap-2 px-2 sm:px-4 py-1 sm:py-2 rounded-lg text-xs sm:text-sm font-medium hover:shadow-lg transition-all duration-300 mx-auto"
                              style={{
                                background:
                                  "linear-gradient(135deg, #2E3E88, #32B9CC)",
                                color: "white",
                ...
                >
                  <div className="flex items-center justify-center gap-1 sm:gap-2">
                    <button
                      ...
                      className={`p-1 sm:p-2 rounded-lg sm:rounded-xl text-xs sm:text-sm ${
                        currentPage === 1
                    ...
                    <div className="flex items-center gap-1 sm:gap-2">
                      {getPaginationNumbers().map((pageNum, index) => (
                        <React.Fragment key={index}>
                          {pageNum === "..." ? (
                            <span
                              className="px-1 sm:px-3 py-1 sm:py-2 text-xs sm:text-sm"
                              style={{ color: "#32B9CC" }}
                            >
                              ...
                            </span>
                            ...
                            <button
                              ...
                              className={`px-2 sm:px-4 py-1 sm:py-2 rounded-lg sm:rounded-xl font-semibold text-xs sm:text-sm ${
                                currentPage === pageNum
          ...
          {(!reportData || reportData.length === 0) && (
            ...
            >
              ...
              <p
                className="mb-4 sm:mb-6 max-w-md mx-auto px-2 text-xs sm:text-sm"
                style={{ color: "#32B9CC" }}
              >
